...
class Tools:
    ...
    def _topology_render_html(self, graph: "nx.Graph", local_label: str, summary: Dict[str, Any]) -> str:
        ...
        # Strip pyvis's Bootstrap card chrome so the diagram fills the
        # embed iframe instead of sitting in a white card frame.
        chrome_strip = """
        <style>
        ...
        #mynetwork { height: 600px !important; border: none !important; }
        </style>
        """
        legend = f"""
        <div style="position:absolute;left:12px;bottom:12px;background:rgba(0,0,0,0.78);
            color:#e6e6e6;border:1px solid #4a4f5a;border-radius:8px;padding:10px 14px;
        ...
        <div style="margin-top:4px;color:#9aa0a6;">Concentric rings = hop count (innermost = directly heard)</div>
        </div>
        """
        return html.replace("</body>", chrome_strip + legend + "\n</body>", 1)
